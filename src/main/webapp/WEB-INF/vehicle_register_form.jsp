...
<nav class="navbar navbar-expand-sm navbar-light bg-light m-3">
    ...
    <div align="center">
        ...
        <form:form action="${pageContext.request.contextPath}/vehicleRegister" method="post" modelAttribute="vehicle" class="m-4">
            ...
            <br/>
 			...
 			<form:label path="active" >is available</form:label>
            <form:checkbox path="active" class="form-control-lg my-3"/><br/>
            
             
            
            
            <form:label path="rentPerHour">Rent/Hour</form:label>
            <form:input path="rentPerHour" class="form-control-sm my-3"/><br/>
             
            
                 
            <form:button class="btn btn-outline-primary">Add Vehicle</form:button>
        </form:form>
    </div>
