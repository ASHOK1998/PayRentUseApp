...
<nav class="navbar navbar-expand-sm navbar-light bg-light m-3">
    ...
    <div align="center">
        <h2>Edit Vendor</h2>
        <form:form action="${pageContext.request.contextPath}/editVendor" method="post" modelAttribute="vendor" class="m-4">
        
 			<form:hidden path="id"/>
 			       	
            <form:label path="name">Full name:</form:label>
            <form:input path="name" class="form-control-sm my-2"/><br/>
             
            <form:label path="email">E-mail:</form:label>
            <form:input path="email" class="form-control-sm my-2"/><br/>
             
            <form:label path="password">Password:</form:label>
            <form:password path="password" class="form-control-sm my-2"/><br/>      
            ...
            <form:input path="phoneNumber" class="form-control-sm my-2"/><br/>
             
            <form:label path="address">Address:</form:label>
            <form:textarea path="address" cols="25" rows="5" class="form-control-sm my-2"/><br/>
