...
<nav class="navbar navbar-expand-sm navbar-light bg-light m-3">
    ...
    <div align="center">
        <h2>Book Vehicle</h2>
        <form:form action="${pageContext.request.contextPath}/addToBookings" method="post" modelAttribute="booking" class="m-4">
            ...
            <form:input path="noOfHours" readonly="true" class="form-control-sm my-3"/><br/>
            
            
            <form:label path="totalAmount">Total Amount:</form:label>
            <form:input path="totalAmount" readonly="true" class="form-control-sm my-3"/><br/>
             
            
                 
            <form:button class="btn btn-outline-primary">Pay Now</form:button>
        </form:form>
    </div>
